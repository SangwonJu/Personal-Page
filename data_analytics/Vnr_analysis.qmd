...
# Font Setting
font_add_google(name="IBM Plex Sans KR") #fonts.google.com에서 고르시면 됨
showtext_auto()
```
...
(korea_tokenized %>%
    ...
    pattern_alpha=1)+
    scale_fill_hue() +
    geom_text(aes(label=n),hjust=-0.1,size=7,family="IBM Plex Sans KR")+
    labs(y = NULL, title="대한민국") +
    theme_bw()+
    theme(plot.title = element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> a)
...
(korea_ngram %>%
    ...
    theme_bw()+
    theme(plot.title =  element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> a1) 
```
...
korea_topic_k_df %>%
    ...
    theme(plot.title = element_text(size=20),
        text=element_text(family="IBM Plex Sans KR",size=40))
```
...
korea_g %>%
    ...
    geom_node_text(aes(label = name, size=degree),size=8, repel = TRUE,family="IBM Plex Sans KR") +
    theme_graph(base_family="IBM Plex Sans KR") +
    theme(text=element_text(family="IBM Plex Sans KR", size=40)) +
    guides(size="none")
```
...
korea_g %>%
    ...
    geom_node_point(aes(colour = community, size = degree)) +
    geom_node_text(aes(label = name),size=8, repel = TRUE,family="IBM Plex Sans KR") +
    theme_graph(base_family="IBM Plex Sans KR") +
    theme(text=element_text(family="IBM Plex Sans KR",size=40)) +
    guides(size="none")+
...
(germany_tokenized %>%
    ...
    theme_bw()+
    theme(plot.title = element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> b)
...
(germany_ngram %>%
    ...
    theme_bw()+
    theme(plot.title =  element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> b1) 
```
...
(finland_tokenized %>%
    ...
    theme_bw()+
    theme(plot.title = element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> c)
...
(germany_ngram %>%
    ...
    theme_bw()+
    theme(plot.title =  element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> c1) 
```
...
(japan_tokenized %>%
    ...
    theme_bw()+
    theme(plot.title = element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> d)
...
(japan_ngram %>%
    ...
    theme_bw()+
    theme(plot.title =  element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> d1) 
```
...
(uk_tokenized %>%
    ...
    theme_bw()+
    theme(plot.title = element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> e)
...
(uk_ngram %>%
    ...
    theme_bw()+
    theme(plot.title =  element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> e1) 
```
...
(austrailia_tokenized %>%
    ...
    theme_bw()+
    theme(plot.title = element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> f)
...
(austrailia_ngram %>%
    ...
    theme_bw()+
    theme(plot.title =  element_text(size=40),
        text=element_text(family="IBM Plex Sans KR",size=25)) -> f1) 
```
...
finland_g %>%
    ...
    geom_node_text(aes(label = name), repel = TRUE,family="IBM Plex Sans KR",size=10, max.overlaps = Inf) +
    theme_graph(base_family="IBM Plex Sans KR") +
    theme(text=element_text(family="IBM Plex Sans KR",size=40)) +
...
compare_six %>%
    ...
    geom_text(aes(label = words), check_overlap = TRUE, vjust = 1.5, family="IBM Plex Sans KR",size=10) +
    ...
    labs(y = "Korea", x = NULL, title="Comparing the word frequencies of Six Countries") +
    theme_bw() +
    theme(plot.title = element_text(size=40),
          text=element_text(family="IBM Plex Sans KR",size=25))+
    guides(color="none")
```
