...
```{r, fig.align='center',fig.width=10,fig.height=7}
#| column: page
korea_lda <-  LDA(korea_dtm, k = 8,
              method="Gibbs",
              control = list(alpha=0.5, iter=1000, seed=2020, thin=3))

korea_tp_8 <- korea_lda %>%
    tidy(matrix = "beta") %>%
    group_by(term) %>%
    slice_max(beta) 
...
```{r, fig.align='center',fig.width=10,fig.height=7}
#| column: page
korea_lda <-  LDA(korea_dtm, k = 9,
              method="Gibbs",
              control = list(alpha=0.5, iter=1000, seed=2020, thin=3))

korea_tp_9 <- korea_lda %>%
    tidy(matrix = "beta") %>%
    group_by(term) %>%
    slice_max(beta) 
...
```{r, fig.align='center',fig.width=10,fig.height=7}
#| column: page
korea_lda <-  LDA(korea_dtm, k = 10,
              method="Gibbs",
              control = list(alpha=0.5, iter=1000, seed=2020, thin=3))

korea_tp_10 <- korea_lda %>%
    tidy(matrix = "beta") %>%
    group_by(term) %>%
    slice_max(beta) 
...
```{r, fig.align='center',fig.width=10,fig.height=7}
#| column: page
germany_lda <-  LDA(germany_dtm, k = 8,
              method="Gibbs",
              control = list(alpha=0.5, iter=1000, seed=2020, thin=3))

germany_tp_8 <- germany_lda %>%
    tidy(matrix = "beta") %>%
    group_by(term) %>%
    slice_max(beta) 
...
```{r, fig.align='center',fig.width=10,fig.height=7}
#| column: page
germany_lda <-  LDA(germany_dtm, k = 9,
              method="Gibbs",
              control = list(alpha=0.5, iter=1000, seed=2020, thin=3))

germany_tp_9 <- germany_lda %>%
    tidy(matrix = "beta") %>%
    group_by(term) %>%
    slice_max(beta) 
...
```{r, fig.align='center',fig.width=10,fig.height=7}
#| column: page
germany_lda <-  LDA(germany_dtm, k = 10,
              method="Gibbs",
              control = list(alpha=0.5, iter=1000, seed=2020, thin=3))

germany_tp_10 <- germany_lda %>%
    tidy(matrix = "beta") %>%
    group_by(term) %>%
    slice_max(beta) 
...
```{r, fig.align='center',fig.width=10,fig.height=7}
#| column: page
austrailia_lda <-  LDA(austrailia_dtm, k = 8,
              method="Gibbs",
              control = list(alpha=0.5, iter=1000, seed=2020, thin=3))

austrailia_tp_8 <- austrailia_lda %>%
    tidy(matrix = "beta") %>%
    group_by(term) %>%
    slice_max(beta) 
...
```{r, fig.align='center',fig.width=10,fig.height=7}
#| column: page
austrailia_lda <-  LDA(austrailia_dtm, k = 9,
              method="Gibbs",
              control = list(alpha=0.5, iter=1000, seed=2020, thin=3))

austrailia_tp_9 <- austrailia_lda %>%
    tidy(matrix = "beta") %>%
    group_by(term) %>%
    slice_max(beta) 
...
```{r, fig.align='center',fig.width=10,fig.height=7}
#| column: page
austrailia_lda <-  LDA(austrailia_dtm, k = 10,
              method="Gibbs",
              control = list(alpha=0.5, iter=1000, seed=2020, thin=3))

austrailia_tp_10 <- austrailia_lda %>%
    tidy(matrix = "beta") %>%
    group_by(term) %>%
    slice_max(beta) 
