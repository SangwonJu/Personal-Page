...
(korea_tokenized %>%
    ...
    ggplot(aes(n, word)) +
    geom_col(fill="red") +
    geom_text(aes(label=n),hjust=-0.1,size=7,family="Uchen")+
    labs(y = NULL, title="Korea") +
    theme_bw()+
    theme(plot.title = element_text(size=30),
        text=element_text(family="Uchen",size=25)) -> a)
...
korea_topic_k_df %>%
    ...
    theme_bw() +
    theme(plot.title = element_text(size=20),
        text=element_text(family="Uchen",size=40))
```
...
korea_g %>%
    ...
    geom_node_text(aes(label = name, size=degree),size=8, repel = TRUE,family="Uchen") +
    theme_graph(base_family="Uchen") +
    theme(text=element_text(family="Uchen", size=40)) +
    guides(size="none")
```
...
korea_g %>%
    ...
    geom_node_point(aes(colour = community, size = degree)) +
    geom_node_text(aes(label = name),size=8, repel = TRUE,family="Uchen") +
    theme_graph(base_family="Uchen") +
    theme(text=element_text(family="Uchen",size=40)) +
    guides(size="none")+
...
(germany_tokenized %>%
    ...
    theme_bw()+
    theme(plot.title = element_text(size=30),
        text=element_text(family="Uchen",size=25)) -> b)
...
(finland_tokenized %>%
    ...
    theme_bw()+
    theme(plot.title = element_text(size=30),
        text=element_text(family="Uchen",size=25)) -> c)
...
finland_g %>%
    ...
    geom_node_text(aes(label = name), repel = TRUE,family="Uchen",size=10, max.overlaps = Inf) +
    theme_graph(base_family="Uchen") +
    theme(text=element_text(family="Uchen",size=40)) +
...
compare_three %>%
    ...
    geom_text(aes(label = words), check_overlap = TRUE, vjust = 1.5, family="Uchen",size=10) +
