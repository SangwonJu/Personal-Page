...
Most important part in the unemployment index analysis is how specific figures were calculated, how the definition of the 'unemployment' was constructed, and how the data were surveyed and acquired.
...
-   There were some discrepancies on employment rate for each presidential regimes. But, this figure only cannot be used as evaluating each presidencies. (unemployment rate can be affected by various factors such as international mechanics, climate change etc.)
