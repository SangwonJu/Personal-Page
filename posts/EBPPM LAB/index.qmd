...
Figure: A flowchart of a text analysis that incorporates topic modeling  (Silge & Robinson, 2017)
:::
...
set.seed(2022)
compare_six %>%
    ggplot(aes(x = proportion, y = Republic_of_Korea, color = abs(Republic_of_Korea - proportion))) +
